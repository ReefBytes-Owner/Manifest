...
_DIRECT_ROWS = (
    ...
    "hook.debug-statements|debug-statement-hook;hook.shellcheck|shellcheck|--severity=warning;"
    "hook.markdownlint-cli2|markdownlint-cli2|--config|.markdownlint.jsonc;"
    "hook.yamllint|yamllint;hook.ruff|ruff|check;hook.ruff-format|ruff|format|--check;"
